...
import { ShoppingCartOutlined, UserOutlined, SearchOutlined,LeftOutlined } from '@ant-design/icons'
import './index.scss';
    ...
    <React.Fragment>
      <div className="header">
        <div className="header__titleContainer">
          <svg className="desktop-only" viewBox="0 0 100 80" width="40" height="40">
              <rect width="80" height="10" rx="8"></rect>
              <rect y="20" width="80" height="10" rx="8"></rect>
              <rect y="40" width="60" height="10" rx="8"></rect>
          </svg>
          <LeftOutlined className="mobile-only" style={{color:'#000', marginLeft:0, fontSize:14}}/>
        ...
        <div className="header__options desktop-only">
        ...
        <div className="header__options mobile-only">
          <SearchOutlined style={{fontSize:24, cursor:'pointer'}} />
          <UserOutlined style={{fontSize:24, cursor:'pointer', marginLeft:16}} />
          <ShoppingCartOutlined style={{fontSize:24, cursor:'pointer', marginLeft:16}} />
        </div>
      </div>
    </React.Fragment>
  )
